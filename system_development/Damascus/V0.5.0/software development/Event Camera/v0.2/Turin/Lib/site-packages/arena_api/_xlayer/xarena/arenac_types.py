...
acODevFileStream = _ctypes.c_void_p
acIDevFileStream = _ctypes.c_void_p
...
# the prototype of the function called by ArenaC when it makes the callback
acDeviceDisconnectCallbackFunction = _ctypes.CFUNCTYPE(None, acDevice)
