...
class AC_O_DEV_FILE_STREAM_OPEN_MODE_LIST(IntEnum):
    # Default open mode (out | trunc)
	AC_O_DEV_FILE_STREAM_OPEN_MODE_DEFAULT = 0,
    # Open for output operations
	AC_O_DEV_FILE_STREAM_OPEN_MODE_OUT = 1,
    # Open in binary mode
	AC_O_DEV_FILE_STREAM_OPEN_MODE_BINARY = 2,
    # Truncate file if it exists
	AC_O_DEV_FILE_STREAM_OPEN_MODE_TRUNC = 4,
    # Append mode
	AC_O_DEV_FILE_STREAM_OPEN_MODE_APPEND = 8,
    # Open and seek to end immediately
	AC_O_DEV_FILE_STREAM_OPEN_MODE_ATE = 16

"""
@class  LucidXYTPPixel
