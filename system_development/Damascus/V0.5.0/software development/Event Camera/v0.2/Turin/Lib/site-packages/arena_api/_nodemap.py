...
class Nodemap():
    ...
    Use the print function to get a list of all feature nodes under
    a nodemap instance.
    """
    # TODO SFW-2115
    ...
    """
    Name of the device which the node map is coming from.
    ...
    **---------------------------------------------------------------**
    ...
    def poll(self, elapsed_time_millisec=None):
        ...
        **Args**:\n
            ...
            The value zero causes a ``ValueError`` to be raised.\n
    ...
    **-------------------------------------------------------------------**
    ...
    def get_node(self, nodes_names):
        ...
        **Returns**:
            ...
            as the value, if ``nodes_names`` is a ``list``.\n
