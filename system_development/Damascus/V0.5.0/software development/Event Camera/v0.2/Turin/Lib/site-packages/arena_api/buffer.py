...
from arena_api._overlay_info import OverlayInfo as _OverlayInfo
...
class _Buffer():
    ...
    chunk must then be selected and enabled via ``ChunkSelector``\
    and ``ChunkEnable``.\n
    ...
    ``buffer.get_chunk()``. Otherwise a exception will be raised.\n
    ...
    **-------------------------------------------------------------------**
    ...
    Frame IDs start at ``1`` and continue until\
    ``2^64-1`` (64-bit), at which point they roll over back to ``1``.\
    The frame ID should never be ``0``.\n
    ...
    **------------------------------------------------------------------**
    ...
    """
    Returns whether or not a buffer's payload has data that may be \
    interpreted as chunk data. ``True`` if the payload has \
    chunk data otherwise, ``False``.\n

    :getter: Returns whether or not a buffer's payload has data that may be \
    ...
    **-------------------------------------------------------------------**
    ...
    def __get_is_compressedimage(self):
        return self.xbuffer.xBufferIsCompressedImage()

    is_compressedimage = property(__get_is_compressedimage)
    """
    Returns whether or not a buffer's payload has data that may \
    be interpreted as compressed image data. ``True`` if the payload has \
    compressed image data otherwise, ``False``.\n

    :getter: Returns whether or not a buffer's payload has data that may be \
    interpreted as compressed image data.\n
    :type: ``bool``.\n
    ...
    **-------------------------------------------------------------------**
    ...
    :getter: Gets the number of bits per pixel of the image buffer\
    ...
    from the integer value of the ``buffer.pixel_format`` (PfncFormat).\
    Internally, a public helper function is called ``get_bits_per_pixel()``.
    ...
    **-------------------------------------------------------------------**
    ...
    def __get_bytes(self):
        return self.xbuffer.xImageGetData().contents

    pbytes = property(__get_bytes)
    # ---------------------------------------------------------------------
    ...
    **-------------------------------------------------------------------**
    ...
    def __get_compressed_image_pixel_format(self):
        pixel_format = self.xbuffer.xCompressedImageGetPixelFormat()
        return _enums.PixelFormat(pixel_format)

    compressed_image_pixel_format = property(__get_compressed_image_pixel_format)
    """
    The compressed buffer's pixel format as an enum, as defined by the\
    PFNC specification.\n
    ...
    **-------------------------------------------------------------------**
    ...
    def __get_compressed_image_timestamp_ns(self):
        return self.xbuffer.xCompressedImageGetTimestampNs()

    compressed_image_timestamp_ns = property(__get_compressed_image_timestamp_ns)
    """
    ...
    Gets the timestamp of the compressed image in nanoseconds. Images are\
    self-describing, so the device does not need to be queried to get\
    this information.\n

    The ``BufferFactory`` can create an compressed image buffer from \
    another compressed image buffer or from a minimal set of parameters \
    ``buffer.data``, ``buffer.width``, ``buffer.height``, \
    ``buffer.pixel_format``. If the image buffer is created from parameters, \
    the timetamp will be set to ``0``, no matter its original value.\n
    ...
    **-------------------------------------------------------------------**
    ...
    def __get_compressed_image_bytes(self):
        return self.xbuffer.xCompressedImageGetData().contents

    compressed_image_pbytes = property(__get_compressed_image_bytes)
    """
    **------------------------------------------------------------------**\
    **-------------------------------------------------------------------**
    """
    ...
    def __get_compressed_image_pdata(self):
        return self.xbuffer.xCompressedImageGetData()

    compressed_image_pdata = property(__get_compressed_image_pdata)
    """
    **------------------------------------------------------------------**\
    **-------------------------------------------------------------------**
    """
    ...
    def __get_compressed_image_data(self):
        return self.xbuffer.xCompressedImageGetData()[:self.xbuffer.xBufferGetPayloadSize()]

    compressed_image_data = property(__get_compressed_image_data)
    """
    **------------------------------------------------------------------**\
    **-------------------------------------------------------------------**
    """
    ...
    def get_chunk(self, chunk_names):
        ...
        **Args**:\n
            chunk_names: it can be:\n
                ...
                - A ``list`` of ``str``.\n
                - A ``tuple`` of ``str``.\n
            - The str's value represents the name of the chunk to retrieve as a node.\
...
class BufferFactory():
    ...
    Images from this factory are treated noticeably differently than those\
    ...
    converting an image with this factory allocates and deallocates memory
    as needed. This is why images from a device must be requeued with\
    ...
    **-------------------------------------------------------------------**
    ...
    def create(pdata, data_size, width, height, pixel_format):
        ...
        if not isinstance(pdata, ctypes.POINTER(ctypes.c_uint8)): # or c_ubyte
            raise TypeError(f'pdata expected instead of '
                            f'{type(pdata).__name__}')

        # pixel_format (str, int, enums.PixelFormat) ----------------------
        if isinstance(pixel_format, str):
            pixel_format = int(_enums.PixelFormat[pixel_format])
    ...
    # create empty ----------------------------------------------------------
    @ staticmethod
    def create_empty(data_size, width, height, pixel_format):
        ...
        hxbuffer_value = _xImagefactory.xImageFactoryCreateEmpty(
            data_size, width, height, pixel_format)
        
        return _Buffer(hxbuffer_value)
    
    # create compressed image -----------------------------------------------
    @ staticmethod
    def create_compressed_image(pdata, data_size, pixel_format):
        ...
        hxbuffer_value = _xImagefactory.xImageFactoryCreateCompressedImage(
            pdata, data_size, pixel_format)
        
        return _Buffer(hxbuffer_value)

    # shallow ---------------------------------------------------------------
    @ staticmethod
    def shallow(pdata, data_size, width, height, pixel_format):
        ...
        hxbuffer_value = _xImagefactory.xImageFactoryShallow(
            pdata, data_size, width, height, pixel_format)
    ...
    def copy(buffer):
     ...
     # copy_compressed_image ------------------------------------------------
    @ staticmethod
    def copy_compressed_image(buffer):
        """
        Creates a deep copy of a compressed image buffer from another \
        ...
        **---------------------------------------------------------------**
        ...
        payload = buffer.payload_type
        if (payload is not _enums.PayloadType.COMPRESSED_IMAGE and
            payload is not _enums.PayloadType.COMPRESSED_IMAGE_EXTENDED_CHUNK):
            raise TypeError(f'Buffer payload type should be a '
                            f'compressed image type instead '
                            f'of {payload}')

        hxbuffer_value = _xImagefactory.xImageFactoryCopyCompressedImage(
            buffer.xbuffer.hxbuffer.value)
        return _Buffer(hxbuffer_value)
    ...
    def decompress_image(buffer):
        ...
        **---------------------------------------------------------------**
        ...
        hxbuffer_value = _xImagefactory.xImageFactoryDecompressImage(
            buffer.xbuffer.hxbuffer.value)
        return _Buffer(hxbuffer_value)
    ...
    def convert(buffer, new_pixel_format, bayer_algorithm=None):
        """
        Converts an image buffer to the selected pixel format. In doing\
        ...
        **Returns**:\n
        ...
        pixel formats differs from a device's pixel formats
        ``PixelFormat`` node. In order for the conversion to succeed, \
        ...
        - Bayer conversion algorithm is only necessary when converting from Bayer
        formats.\n
    ...
    # destroy_compressed_image ----------------------------------------------
    @ staticmethod
    def destroy_compressed_image(buffer):
        """
        Destroyes a compressed image buffer.\n
        ...
        **---------------------------------------------------------------**
        ...
        _xImagefactory.xImageFactoryDestroyCompressedImage(buffer.xbuffer.hxbuffer.value)

    # select bits ----------------------------------------------------------------
    @ staticmethod
    def select_bits(buffer, num_bits, offset):
        """
        ...
        **Returns**:\n
            - ``_Buffer`` instance with new scale. This is a new\
            instance.\n
        ...
        **---------------------------------------------------------------**
        ...
        if num_bits != 8:
            raise TypeError(f'Numer of Bits must be <8>')
        
        hxbuffer_value = _xImagefactory.xImageFactorySelectBits(
            buffer.xbuffer.hxbuffer.value, num_bits, offset)

        return _Buffer(hxbuffer_value)

    # select bits and scale ------------------------------------------------------
    @ staticmethod
    def select_bits_and_scale(buffer, num_bits, offset):
        """
        ...
        **---------------------------------------------------------------**
        ...
        hxbuffer_value = _xImagefactory.xImageFactorySelectBitsAndScale(
            buffer.xbuffer.hxbuffer.value, num_bits, offset)

        return _Buffer(hxbuffer_value)
    
    # process software lut ----------------------------------------------------------
    @ staticmethod
    def process_software_lut(buffer, plut, len):
        """
        ...
        **Returns**:\n
            - ``_Buffer`` instance processed with lookup table. This is a new\
            instance.\n
        ...
        **---------------------------------------------------------------**
        ...
        if not isinstance(plut, ctypes.POINTER(ctypes.c_uint8)): # or c_ubyte
            raise TypeError(f'pdata expected instead of '
                            f'{type(plut).__name__}')

        hxbuffer_value = _xImagefactory.xImageFactoryProcessSoftwareLUT(
            buffer.xbuffer.hxbuffer.value, plut, len)

        return _Buffer(hxbuffer_value)
    
    # deinterleave channels ----------------------------------------------------------
    @ staticmethod
    def deinterleave_channels(buffer):
        """
        Separates interleaved channels into a planar image.\n

        **Args**:\n
            buffer:\n
            - A ``_Buffer`` instance to separate. It must be created by\
            ``BufferFactory``.\n

        **Returns**:\n
            - ``_Buffer`` instance with a planar image. This is a new\
            instance.\n
    ...
    # deinterleave channels shallow ----------------------------------------------------------
    @ staticmethod
    def deinterleave_channels_shallow(buffer, pdata, len):
        """
        Separates interleaved channels into a planar image.\n
        ...
        **---------------------------------------------------------------**
        ...
        hxbuffer_value = _xImagefactory.xImageFactoryDeinterleaveChannelsShallow(
            buffer.xbuffer.hxbuffer.value, pdata, len)
        
        return _Buffer(hxbuffer_value)
    
    # deinterleave channels len ----------------------------------------------------------
    @ staticmethod
    def deinterleave_channels_len(buffer):
        """
        Return length of buffer that needed for a planar image.\n

        **Args**:\n
            buffer:\n
            - A ``_Buffer`` instance to calculate a separated image. It must be created by\
            ``BufferFactory``.\n
    ...
    def split_channels(buffer):
        ...
        **Args**:\n
            buffer:\n
            - A ``_Buffer`` instance to split. It must be created by\
            ``BufferFactory``.\n

            **Returns**:\n
            - ``_Buffer`` instance in a vector with split images. This is a new\
            instance.\n
        ...
        **---------------------------------------------------------------**
        ...
        # pf = buffer_deinterleave.pixel_format
        ...
        _xImagefactory.xImageFactoryDestroy(buffer_deinterleave.xbuffer.hxbuffer.value)

        return buffer_array

    # overlay ----------------------------------------------------------
    @ staticmethod
    def overlay(depth_buffer, rgb_buffer, overlay_info):
        """
        Overlays a 2D image onto a 3D image.\n

        **Args**:\n
            depth_buffer:\n
            - A ``_Buffer`` instance to retrieve from helios. It must be created by\
            ``BufferFactory``.\n

            rgb_buffer:\n
            - A ``_Buffer`` instance to retrieve from triton. It must be created by\
            ``BufferFactory``.\n

            **Returns**:\n
            - A ``_Buffer`` instance overlay info object to return. This is a new\
            instance.\n
        ...
        **---------------------------------------------------------------**
        ...
        if not isinstance(depth_buffer, _Buffer):
            raise TypeError(f'Buffer expected instead '
                            f'of {type(depth_buffer).__name__}')
        
        if not isinstance(rgb_buffer, _Buffer):
            raise TypeError(f'Buffer expected instead '
                            f'of {type(rgb_buffer).__name__}')
        
        if not isinstance(overlay_info, _OverlayInfo):
            raise TypeError(f'OverlayInfo expected instead '
                            f'of {type(overlay_info).__name__}')
        
        hxbuffer_value = _xImagefactory.xImageFactoryOverlay(
            depth_buffer.xbuffer.hxbuffer.value,
            rgb_buffer.xbuffer.hxbuffer.value,
            overlay_info._xoverlay_info.hxoverlay_info.value)

        return _Buffer(hxbuffer_value)
    
    # create overlay info ----------------------------------------------------------
    @ staticmethod
    def create_overlay_info(chroma, helios):
        
        from arena_api._device import Device as _Device

        """
        Creates overlay info object.\n
        
        **Args**:\n
            chroma:\n
            - A ``_Device`` instance which should be a triton camera.\n

            helios:\n
            - A ``_Device`` instance which should be a helios camera.\n

            **Returns**:\n
            - ``_OverlayInfo`` overlay info object to return. This is a new\
            instance.\n

        Objects from this method factory must be destroyed via\
        ``BufferFactory.destroy_overlay_info()``.\n
        ...
        **---------------------------------------------------------------**
        ...
        if not isinstance(chroma, _Device):
            raise TypeError(f'Device expected instead '
                            f'of {type(chroma).__name__}')
        
        if not isinstance(helios, _Device):
            raise TypeError(f'Device expected instead '
                            f'of {type(helios).__name__}')
        
        hxoverlay_info = _xImagefactory.xImageFactoryCreateOverlayInfo(
            chroma._xdev.hxdevice.value, helios._xdev.hxdevice.value)

        return _OverlayInfo(hxoverlay_info)
    
    # destroy overlay info ----------------------------------------------------------
    @ staticmethod
    def destroy_overlay_info(overlay_info):
        """
        Destroy overlay info object.\n

        **Args**:\n
            overlay_info:\n
            - A ``_OverlayInfo`` instance to destroy. it must be created by\
            ``BufferFactory``.\n

        **Raises**:\n
            - ``TypeError``:\n
                - ``overlay_info`` is not of type ``_OverlayInfo``.\n

        **Returns**:\n
        - ``None``.\n

        Cleans up an overlay info object and deallocates its\
        memory. 

        :warning:\n
        - Overlay info objects from the image factory must be destroyed.\n
        ...
        **---------------------------------------------------------------**
        ...
        _xImagefactory.xImageFactoryDestroyOverlayInfo(overlay_info)