...
class Node():
    ...
    # def __get_is_available(self):
    #     return _xGlobal.xIsAvailable(self.xnode.hxnode.value)

    # is_available = property(__get_is_available)
...
class NodeEnumentry(Node):
    ...
    # ---------------------------------------------------------------------
    # overrides the base class, node, name property because enums needs
    ...
    def __get_int_value(self):
        return self.xenumentry.xEnumEntryGetIntValue()

    int_value = property(__get_int_value)
